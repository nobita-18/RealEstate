...
const SellerLogin = () => {
  ...
  return (
    <div className="seller-login-page-wrapper fade-in-page">
      ...
      {showSocialModal && (
        <div className="social-modal-overlay" style={{
          position: 'fixed',
          top: 0,
          left: 0,
          right: 0,
          ...
          <div className="social-modal-content" style={{
            background: '#ffffff',
            borderRadius: '16px',
            padding: '24px',
            width: '100%',
            ...
            {/* Logo container */}
            <div style={{ display: 'inline-flex', padding: '12px', borderRadius: '12px', background: '#f8fafc', marginBottom: '15px' }}>
            ...
            <p style={{ fontSize: '0.85rem', color: '#64748b', margin: '0 0 20px 0' }}>
              Choose a Seller account to continue to dashboard
            </p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', textAlign: 'left', marginBottom: '20px' }}>
              {[
                ...
                { name: 'Chennai Prime', email: 'chennaiprime@gmail.com', role: 'Seller', desc: 'Registered' },
                { name: 'Guest Seller', email: 'guest_seller@gmail.com', role: 'Seller', desc: 'Unregistered' }
              ].map((acc, index) => (
                <button
                  key={index}
                ...
                >
                  ...
                  <span style={{ fontSize: '0.7rem', fontWeight: 'bold', padding: '3px 8px', borderRadius: '12px', background: '#e0f2fe', color: '#0284c7' }}>
                    {acc.role}
                  </span>
                </button>
              ))}
