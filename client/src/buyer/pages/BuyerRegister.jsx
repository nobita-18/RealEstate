  ...
  useEffect(() => {
    const handleOAuthCallback = async () => {
      ...
      try {
        ...
        try {
          const checkRes = await axios.post('http://localhost:5000/api/auth/social-login', { 
            email, 
            provider 
          });
        ...
        const registerRes = await axios.post('http://localhost:5000/api/auth/register', submitData, {
